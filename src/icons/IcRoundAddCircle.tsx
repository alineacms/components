...
export function IcRoundAddCircle({ fill, ...props }: SVGProps<SVGSVGElement> & { fill?: string }) {
  return (
    <svg
      ...
      height="1em"
      viewBox="0 0 24 24"
      fill={fill || "currentColor"} // Gebruik `fill` als die is meegegeven, anders `currentColor`
      {...props}
    >
      <path
